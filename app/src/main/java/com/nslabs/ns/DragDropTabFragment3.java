 ...
 */
public class DragDropTabFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_drag_drop_tab_fragment3, container, false);
        ...
        Scores=mySharedPreferences.getString("test1","0");

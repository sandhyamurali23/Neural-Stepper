    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(test3.this);
                ...
                alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(test3.this, NavActivity.class);
        ...
        final PageAdapterReaction adapter=new PageAdapterReaction(getSupportFragmentManager(),tabLayout.getTabCount());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bGetStarted:
                Intent myIntent = new Intent(test3.this, reactiontime.class);
